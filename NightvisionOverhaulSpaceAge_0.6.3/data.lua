...
data:extend({
  ...
  -- Recycling Recipes
  -- Recycling MK2 (returns ingredients except MK1)
  {
    type = "recipe",
  ...
  -- Recycling MK3 (returns ingredients except MK2)
  {
    type = "recipe",
  ...
  -- Technology: Nightvision MK2
  {
    ...
    prerequisites = {"night-vision-mk1", "carbon-fiber"},
    unit = {
      count = 750,
      ingredients = {
        {"automation-science-pack", 1},
  ...
  -- Technology: Nightvision MK3
  {
    ...
    prerequisites = {"night-vision-mk2", "carbon-fiber", "electromagnetic-plant"},
    unit = {
      count = 1000,
      ingredients = {
        {"automation-science-pack", 1},
